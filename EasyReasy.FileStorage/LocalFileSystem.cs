...
public class LocalFileSystem : IFileSystem, IWatchableFileSystem
{
    ...
    /// <inheritdoc/>
    public Task<Stream> OpenFileForWritingAsync(string path, CancellationToken cancellationToken = default)
    {
        ...
        return Task.FromResult<Stream>(new FileStream(fullPath, FileMode.Create, FileAccess.Write, FileShare.None, 4096, FileOptions.Asynchronous));
    }
